...
export function BackgroundPaths({
  ...
  subtitle = "World Cup prediction & simulation platform",
  ...
  return (
    <div className="relative min-h-[calc(100vh-56px)] w-full flex items-center justify-center overflow-hidden bg-neutral-950">
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6 text-center">
        ...
        >
          ...
          <motion.p
            ...
            className="text-white/50 text-lg md:text-xl mb-10"
          >
            {subtitle}
          </motion.p>
          ...
          >
            <Button
              asChild
              variant="ghost"
              className="rounded-[1.15rem] px-8 py-6 text-lg font-semibold backdrop-blur-md bg-black/80 hover:bg-black/90 text-white transition-all duration-300 group-hover:-translate-y-0.5 border border-white/10"
            >
